...
|-----------------------------------------|----------|-----------|------------|------------------------------------|----------------|----------------------------------------------------------------------------------------------------------|
| Full Authentication (API ID/Hash + Code)  | Critical | E2E       | 📝 Test Code Written | `documentation/e2e_scenarios/auth_flow_scenarios.md` | ---            | Detailed scenarios outlined. Covers successful auth, invalid credentials, invalid phone format, incorrect code, and loading states. Implementation with Cypress/Playwright pending. |
| Full Authentication with 2FA            | High     | E2E       | 📝 Test Code Written | `documentation/e2e_scenarios/auth_2fa_flow_scenarios.md` | ---            | Detailed scenarios outlined in `auth_2fa_flow_scenarios.md`. Covers successful 2FA auth, incorrect 2FA password, and loading states. Implementation with Cypress/Playwright pending. |
